...
export class Table {
    constructor({ data = [], columns = [], config = {}, theme = "default", classes = null, targetContainerId = "table-container", inData, inColumns, inConfig, inTheme, inClasses, inTargetContainerId } = {}) {
